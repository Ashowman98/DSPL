...
exp_root = ''
save_dir = './results'    # Evaluation save dir
...
cifar_oods_root = '../data/oodds'                                        # CIFAR100
cub_root = ''                                                   # CUB
...
svhn_root = '../data'                   # SVHN
tin_train_root_dir = '../data/tiny-imagenet-200/train'        # TinyImageNet Train
tin_val_root_dir = '../data/tiny-imagenet-200/val1'     # TinyImageNet Val
imagenet_root = '/home/wsco/wrokspace/lhy/ILSVRC2012'              # ImageNet-1K
